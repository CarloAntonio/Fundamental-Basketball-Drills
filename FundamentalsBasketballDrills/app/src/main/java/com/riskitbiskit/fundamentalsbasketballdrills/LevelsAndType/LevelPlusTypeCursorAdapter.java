...
public class LevelPlusTypeCursorAdapter extends CursorAdapter {
    public LevelPlusTypeCursorAdapter(Context context, Cursor c) {
        super(context, c, 0);
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String drillName = cursor.getString(cursor.getColumnIndex(DrillListEntry.SKILL_NAME));
        int drillCompletion = cursor.getInt(cursor.getColumnIndex(DrillListEntry.SKILL_COMPLETION));
